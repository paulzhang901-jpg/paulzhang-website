...
export async function generateMetadata({params}:Props){const slug=(await params).slug;return isCommunitySection(slug)?metadataForCommunitySection(slug,"en-US"):{};}
