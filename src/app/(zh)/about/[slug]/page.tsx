...
export async function generateMetadata({params}:Props){const slug=(await params).slug;return isAboutSection(slug)?metadataForCollectionRoute("about",slug,"zh-CN"):{};}
