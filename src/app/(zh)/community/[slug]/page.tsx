...
export async function generateMetadata({params}:Props){const slug=(await params).slug;return isCommunitySection(slug)?metadataForCollectionRoute("community",slug,"zh-CN"):{};}
