...
const sectionCopy:Record<ContentLanguage,Record<CommunitySectionId,Copy>>={
  "zh-CN":{
    church:{label:"教会介绍（FCFMC）",seoTitle:"印城第一华人循理会",summary:"认识 First Chinese Free Methodist Church of Indianapolis（FCFMC）的信仰传统、属灵归属、当前聚会地点与未来方向。",seoDescription:"认识印城第一华人循理会（FCFMC）：我们的卫斯理宗与循理会传统、Crossroads Conference 归属、Greenfield 当前聚会地点及教会网络入口。"},
  ...
  "en-US":{
    church:{label:"Church Introduction",seoTitle:"First Chinese Free Methodist Church of Indianapolis",summary:"Meet FCFMC through our Free Methodist heritage, conference connection, current gathering place, and direction for the future.",seoDescription:"Meet First Chinese Free Methodist Church of Indianapolis (FCFMC), including our Wesleyan and Free Methodist heritage, Crossroads Conference connection, current Greenfield gathering location, and official church links."},
