...
const zh = {
  ...
  about: {title: "认识与你同行的人", body: "我是张崇助，一位牧者、学习者，也愿意在真实生命里与人同行。这个平台从真理出发，在故事与关系中寻找忠心的下一步。", cta: "认识我的故事"},
  connect: {title: "如果你愿意，我们可以继续同行。", body: "接收新分享的功能仍在预备中。我们不会在尚未连接服务时收集或丢弃你的邮箱。", placeholder: "电子邮箱", status: "订阅服务尚未启用", submit: "继续同行"},
...
const en = {
  ...
  about: {title: "Meet a fellow traveler", body: "I'm Paul Zhang, a pastor and learner who wants to walk with people in real life. This platform begins with truth and seeks a faithful next step through story and relationship.", cta: "Read my story"},
  connect: {title: "If you would like, we can keep walking together.", body: "New-sharing delivery is still being prepared. We will not collect or discard your email before a service is connected.", placeholder: "Email address", status: "Connection service is not yet enabled", submit: "Stay connected"},
