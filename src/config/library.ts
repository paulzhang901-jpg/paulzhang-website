...
export const libraryCopy = {
  "zh-CN": {
    ...
    earlyTitle: "这是一座认真建造、逐步开放的资源库。",
    earlyBody: "正式资源会在完成内容、神学、双语与技术审查后逐步发布。以后你可以按主题、内容类型和生命成长的关联来探索；每一项资源都会保留清楚的来源、语言与更新状态。",
    resource: "篇资源",
  ...
  "en-US": {
    ...
    earlyTitle: "A library built carefully and opened gradually.",
    earlyBody: "Resources will appear after editorial, theological, bilingual, and technical review. As the library grows, you will be able to explore by topic, resource type, and formation relevance, with clear source, language, and update information.",
    resource: "resources",
