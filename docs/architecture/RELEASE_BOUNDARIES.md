...
Groups/cohorts/discussions, mentor workflows and matching/dashboard, Rule of Life, assessments, AI Mentor Assistant, disciple-making workflows, Serve → Lead → Multiply, GCCM integration, leadership development, and multiplication metrics.

Future scope must not enter V1 for technical convenience. See [Version Scope](../product/VERSION_SCOPE.md) and [ADR-0008](../adr/0008-version-boundaries.md).
