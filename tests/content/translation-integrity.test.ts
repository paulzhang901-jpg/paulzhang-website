...
test("canonical translations preserve identity across localized slugs", () => {
  const zh = item();
...
test("missing translations are explicitly unavailable", () => {
...
test("public translation boundary covers every approved translation state", () => {
